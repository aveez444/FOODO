...
// LOCAL IMAGE IMPORTS
import demo1 from "../assets/products/cashews.jfif";
import demo2 from "../assets/products/almonds.jpg";
...
// Changed productData for Whole Cashews W320 (500g)
const productData = {
  id: "whole-cashews-w320",
  title: "Whole Cashews W320 (500g)",
  rating: 4.0,
  reviews: 150,
  price: 499,
  currency: "₹",
  inStock: true,
  short: "Premium whole cashews. Delicious and packed with protein.",
  images: [demo1, demo2, demo3, demo4], // Assume cashews image first
};
...
function SpecTable() {
  const rows = [
    ...
    ["Storage", "Store airtight, protect from moisture"],
  ];
  return (
...
function DriveRates() {
  ...
  const weightOptions = [
    ...
    { weight: 500, price: 499.00, label: "Medium Pack" }, // changed price 449->499
    { weight: 1000, price: 800.99, label: "Large Pack" }, // 1kg
    { weight: 2000, price: 1400.99, label: "Family Pack" }, // 2kg
  ];
