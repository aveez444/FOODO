...
// LOCAL IMAGE IMPORTS
import demo3 from "../assets/products/saffron-pistachios.jpg";
import demo2 from "../assets/products/cashews.jfif";
import demo4 from "../assets/products/dates.jfif";
import demo1 from "../assets/products/khajoor-dates.jfif";
...
const productData = {
  id: "saffron-pistachios-001",
  title: "Saffron Pistachios",
  rating: 4.9,
  reviews: 142,
  price: 900,
  currency: "₹",
  inStock: true,
  short: "Delicious saffron-infused pistachios, premium quality nuts perfect for snacking or gourmet recipes.",
  images: [demo3, demo4, demo2, demo1],
};
...
function SpecTable() {
  const rows = [
    ["Brand", "Saffron Pistachios Co."],
    ["Type", "Saffron Pistachios"],
    ["Origin", "Middle East"],
    ["Shelf Life", "8 months"],
...
function DriveRates() {
  ...
  const weightOptions = [
    { weight: 200, price: 390.99, label: "Small Pack" },
    { weight: 500, price: 900.00, label: "Medium Pack" },
    { weight: 1000, price: 1700.00, label: "Large Pack" },
    { weight: 2000, price: 3200.00, label: "Family Pack" },
  ];
      ...
      <header className="sticky top-0 z-30 border-b bg-white/80 backdrop-blur">
        <div className="mx-auto flex max-w-6xl items-center justify-between gap-3 px-4 py-3">
          <div className="flex items-center gap-4">
            <span className="text-lg font-extrabold">Saffron Pistachios</span>
          </div>
