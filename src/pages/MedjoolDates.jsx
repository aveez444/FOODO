...
const productData = {
  id: "medjool-dates-400g",
  title: "Medjool Dates (400g)",
  rating: 4.7,
  reviews: 120,
  price: 350,
  currency: "₹",
  inStock: true,
  short: "Fresh Medjool dates, 400g pack, sweet and rich in flavor for snacking or cooking.",
...
function DriveRates() {
  const [weight, setWeight] = useState(400); // Default to 400g for Medjool Dates

  // Different pricing for different weight brackets (in grams)
  const weightOptions = [
    { weight: 200, price: 170.99, label: "Small Pack" },
    { weight: 400, price: 350.00, label: "Medium Pack" },
    { weight: 1000, price: 650.99, label: "Large Pack" }, // 1kg (can be adjusted if needed)
    { weight: 2000, price: 1200.99, label: "Family Pack" }, // 2kg
  ];
      ...
      <header className="sticky top-0 z-30 border-b bg-white/80 backdrop-blur">
        <div className="mx-auto flex max-w-6xl items-center justify-between gap-3 px-4 py-3">
          <div className="flex items-center gap-4">
            <span className="text-lg font-extrabold">Medjool Dates</span>
          </div>
