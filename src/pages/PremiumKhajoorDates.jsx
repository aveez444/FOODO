...
// LOCAL IMAGE IMPORTS
import demo1 from "../assets/products/almonds.jpg";
...
const productData = {
  id: "premium-khajoor-dates",
  title: "Premium Khajoor Dates",
  rating: 4.9,
  reviews: 165,
  price: 499,
  currency: "₹",
  inStock: true,
  short: "Premium quality Khajoor dates, rich in flavor and ideal for snacking or recipes.",
  images: [demo4, demo3, demo2, demo1], // Khajoor images first
};
const related = [
  {
    id: "rel-1",
...
function Breadcrumbs() {
  const crumbs = ["Home", "Dried Fruits", productData.title];
  return (
...
function DriveRates() {
  const [weight, setWeight] = useState(400); // Default to 400g for Khajoor Dates
  // Different pricing for different weight brackets (in grams)
  const weightOptions = [
    { weight: 200, price: 190.99, label: "Small Pack" },
    { weight: 400, price: 499.00, label: "Medium Pack" },
    { weight: 1000, price: 899.00, label: "Large Pack" }, // 1kg
    { weight: 2000, price: 1699.00, label: "Family Pack" }, // 2kg
  ];
      ...
      <header className="sticky top-0 z-30 border-b bg-white/80 backdrop-blur">
        <div className="mx-auto flex max-w-6xl items-center justify-between gap-3 px-4 py-3">
          <div className="flex items-center gap-4">
            <span className="text-lg font-extrabold">Premium Khajoor Dates</span>
          </div>
