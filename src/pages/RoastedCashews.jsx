...
// LOCAL IMAGE IMPORTS
import demo2 from "../assets/products/roasted-cashews.jfif";
...
const productData = {
  ...
  currency: "₹",
  inStock: true,
  short: "Delicious roasted cashews, crunchy and perfect for snacking or gifting.",
  images: [demo2, demo1, demo3, demo4],
};
const related = [
  {
    id: "rel-1",
...
function DriveRates() {
  const [weight, setWeight] = useState(500); // Default to 500g for Roasted Cashews
  const weightOptions = [
    { weight: 200, price: 6.99, label: "Small Pack" },
    { weight: 500, price: 680.00, label: "Medium Pack" },
    { weight: 1000, price: 1300.00, label: "Large Pack" },
    { weight: 2000, price: 2500.00, label: "Family Pack" },
  ];
      ...
      <header className="sticky top-0 z-30 border-b bg-white/80 backdrop-blur">
        <div className="mx-auto flex max-w-6xl items-center justify-between gap-3 px-4 py-3">
          <div className="flex items-center gap-4">
            <span className="text-lg font-extrabold">Roasted Cashews</span>
          </div>
