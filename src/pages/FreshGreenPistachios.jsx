...
// LOCAL IMAGE IMPORTS
import demo1 from "../assets/products/pistachios.jpg"; // Fresh Green Pistachios image first
...
// Updated productData for Fresh Green Pistachios (250g)
const productData = {
  id: "fresh-green-pistachios",
  title: "Fresh Green Pistachios (250g)",
  rating: 4.8,
  reviews: 150,
  price: 399,
  currency: "₹",
  inStock: true,
  short: "Fresh green pistachios sourced from select farms.",
...
function SpecTable() {
  const rows = [
    ["Brand", "Fresh Green Farms"],
    ["Type", "Pistachios"],
    ["Origin", "Select Farms"],
    ["Shelf Life", "4 months"],
    ["Storage", "Keep dry, consume within 4 months"],
  ];
  return (
...
function DriveRates() {
  const [weight, setWeight] = useState(250); // Default to 250g for pistachios
  const weightOptions = [
    { weight: 200, price: 180.99, label: "Small Pack" },
    { weight: 250, price: 399.0, label: "Medium Pack" },
    { weight: 1000, price: 590.99, label: "Large Pack" },
    { weight: 2000, price: 1100.99, label: "Family Pack" },
  ];
      ...
      <header className="sticky top-0 z-30 border-b bg-white/80 backdrop-blur">
        <div className="mx-auto flex max-w-6xl items-center justify-between gap-3 px-4 py-3">
          <div className="flex items-center gap-4">
            <span className="text-lg font-extrabold">Fresh Green Pistachios (250g)</span>
          </div>
